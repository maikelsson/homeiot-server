        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                this.mqttClient.on("error", function (err) {
                    var _a;
                    console.log(err);
                    (_a = _this.mqttClient) === null || _a === void 0 ? void 0 : _a.end();
                });
                this.mqttClient.on("connect", function () {
                    console.log("mqtt client connected to topic: " + _this.topic);
                });
                ...
                this.mqttClient.on("message", function (topic, message) {
                    return __awaiter(this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    payloadObj = JSON.parse(message.toString());
                                    // console.log("message payload: ", payloadObj);
                                    console.log(payloadObj);
                                    if (!(payloadObj.name === "DHT11-LDR")) return [3 /*break*/, 2];
                                    return [4 /*yield*/, (0, influx_1.writeData)(payloadObj)];
                                case 1:
                                    _a.sent();
                                    _a.label = 2;
